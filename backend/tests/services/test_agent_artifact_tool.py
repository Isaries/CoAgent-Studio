...
@pytest.mark.asyncio()
async def test_agent_create_task_artifact(db_session: AsyncSession, mock_superuser, mock_broadcast):
...
@pytest.mark.asyncio()
async def test_agent_update_artifact(db_session: AsyncSession, mock_superuser, mock_broadcast):
...
@pytest.mark.asyncio()
async def test_agent_delete_artifact(db_session: AsyncSession, mock_superuser, mock_broadcast):
