...
<template>
    <div class="space-y-6">
        ...
        <!-- Create Form -->
        <div v-if="showCreate" class="card bg-base-100 shadow-lg border border-primary/20 animate-fade-in">
            <div class="card-body">
                <input v-model="newTitle" type="text" placeholder="Title" class="input input-bordered font-bold" />
                <textarea v-model="newContent" class="textarea textarea-bordered h-24" placeholder="Content..."></textarea>
        ...
        <div v-else class="space-y-4">
            <div v-for="ann in announcements" :key="ann.id" class="card bg-base-100 shadow-sm border border-base-200">
