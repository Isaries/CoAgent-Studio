      ...
      <div v-if="show" class="modal-box">
        ...
        <div class="py-4 flex flex-col gap-3">
            ...
            <div class="form-control">
                ...
                <select v-model="form.role" class="select select-bordered" :disabled="form.id === currentUser?.id">
            ...
            <div class="form-control">
                ...
                <input type="password" v-model="form.password" placeholder="Leave blank to keep unchanged" class="input input-bordered" />
            </div>
        </div>
