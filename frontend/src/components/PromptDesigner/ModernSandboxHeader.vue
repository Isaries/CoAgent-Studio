...
<template>
  <div
    class="p-3 bg-base-100 rounded-lg border border-primary/20 shadow-[0_0_15px_rgba(var(--p),0.1)] relative overflow-hidden group"
  >
    <!-- Glow Effect -->
    <div
      class="absolute -top-10 -right-10 w-20 h-20 bg-primary/10 rounded-full blur-2xl group-hover:bg-primary/20 transition-all"
    ></div>
      ...
      <div class="grid grid-cols-2 gap-2">
        ...
        <div class="form-control">
          ...
          >
            ...
            <option v-for="m in availableSandboxModels" :key="m.value" :value="m.value">
              {{ m.label }}
            </option>
          </select>
        </div>
