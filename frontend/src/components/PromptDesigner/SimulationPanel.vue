...
<template>
  <div class="flex flex-col h-full bg-[#181818] relative">
    ...
    <div class="flex-1 overflow-y-auto p-6 scroll-smooth custom-scrollbar relative">
      ...
      <div v-if="loading" class="flex justify-start mb-6 animate-pulse">
        <div class="flex gap-3 max-w-[80%]">
          <div
            class="w-8 h-8 rounded-full bg-purple-500/20 flex flex-shrink-0 items-center justify-center border border-purple-500/30"
          >
      ...
      <div v-if="simulationOutput" class="flex justify-start mb-10 group">
        <div class="flex gap-4 w-full max-w-4xl">
          <!-- Avatar -->
          <div
            class="w-8 h-8 rounded-full bg-purple-600 flex flex-shrink-0 items-center justify-center shadow-lg shadow-purple-900/50 mt-1"
          >
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-1">
              ...
              <div class="opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                ...
                <button
                  ...
                  class="btn btn-xs btn-ghost text-error opacity-70 hover:opacity-100"
                  title="Clear"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <!-- Markdown Content -->
            <div
              class="markdown-body text-sm leading-relaxed text-gray-300 p-4 bg-[#232323] rounded-2xl rounded-tl-none border border-white/5 shadow-sm"
            >
    ...
    <!-- Bottom: Chat Input -->
    <div
      class="border-t border-white/5 bg-[#1e1e1e] p-4 relative z-20 shadow-[0_-5px_20px_rgba(0,0,0,0.3)]"
    >
