...
const { t } = useI18n()
const { isOpen, query, selectedIndex, results, close, moveUp, moveDown, executeSelected, execute } =
  useCommandPalette()
...
<template>
  <Teleport to="body">
    ...
    >
      ...
      <div
        class="relative w-full max-w-lg bg-base-100 rounded-box shadow-2xl border border-base-300 overflow-hidden"
      >
        <!-- Search Input -->
        ...
        <!-- Footer -->
        <div
          class="flex items-center gap-4 px-4 py-2 border-t border-base-300 text-xs text-base-content/40"
        >
          <span
            ><kbd class="kbd kbd-xs">&uarr;</kbd><kbd class="kbd kbd-xs">&darr;</kbd> navigate</span
          >
