  ...
  <div class="flex flex-col h-full bg-base-100">
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-4">
      <div
        ...
        class="flex h-full items-center justify-center text-center opacity-50 space-y-2 flex-col"
      >
        <svg
      ...
      >
        <div
          class="chat-bubble whitespace-pre-wrap text-sm"
          :class="
            msg.role === 'user'
              ? 'chat-bubble-primary'
              : 'chat-bubble-base-200 bg-base-200 text-base-content'
          "
        >
          {{ msg.text }}
        </div>
