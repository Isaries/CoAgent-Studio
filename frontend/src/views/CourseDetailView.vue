...
const handleDeleteCourse = async () => {
  if (
    !(await confirm(
      'Delete Course',
      'DANGER: Are you sure you want to delete this ENTIRE course? All rooms and messages will be lost.'
    ))
  )
    return
  try {
...
<template>
  <div class="w-full">
    ...
    <!-- Modals -->
    <CreateRoomModal ref="createRoomModal" :courseId="courseId" @created="onRoomCreated" />

    <EnrollStudentModal ref="enrollModal" :courseId="courseId" @enrolled="onEnrolled" />

    <AssignStudentModal ref="assignModal" :roomId="activeRoomId" @assigned="onAssigned" />
  </div>
</template>
