  ...
  <div class="p-6 max-w-4xl mx-auto">
    <div class="mb-8">
      ...
      <p class="text-gray-500 text-sm mt-1">
        Configure global default behaviors for utility agents.
      </p>
    </div>
    ...
    <div v-else class="grid grid-cols-1 gap-8">
      ...
      <div class="card bg-base-100 shadow-xl border border-base-300">
        <div class="card-body">
          <div class="flex justify-between items-start">
            <div>
              ...
              <p class="text-sm opacity-70">
                This agent is responsible for writing System Prompts for Teacher/Student agents
          ...
          <div class="form-control mb-4">
            ...
            <label class="label"
              ><span class="label-text-alt text-warning text-xs"
                >If provided, this will be used for all prompt generation tasks unless overridden.
                Leave empty to clear/unset.</span
              ></label
            >
          </div>
          ...
          <div class="form-control mb-4">
            <label class="label"
              ><span class="label-text font-bold">System Meta-Prompt</span></label
            >
            <textarea
              v-model="configs.design.prompt"
              class="textarea textarea-bordered h-48 font-mono text-sm"
              placeholder="You are an expert prompt engineer..."
            ></textarea>
            <label class="label"
              ><span class="label-text-alt"
                >Instruction used to guide the Design Agent.</span
              ></label
            >
          </div>

          <div class="card-actions justify-end">
            <button @click="saveAgent('design')" class="btn btn-primary">
              Save Design Agent Config
            </button>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="flex justify-between items-start">
            <div>
              ...
              <p class="text-sm opacity-70">
                This agent analyzes chat logs and provides insights to teachers.
              </p>
            </div>
          </div>
          ...
          <div class="form-control mb-4">
            ...
            <input
              type="password"
              v-model="configs.analytics.apiKey"
              placeholder="sk-..."
          ...
          <div class="form-control mb-4">
            ...
            >
            <textarea
              v-model="configs.analytics.prompt"
              class="textarea textarea-bordered h-48 font-mono text-sm"
          ...
          <div class="card-actions justify-end">
            <button @click="saveAgent('analytics')" class="btn btn-secondary">
              Save Analytics Agent Config
            </button>
          </div>
        </div>
      </div>
