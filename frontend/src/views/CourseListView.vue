    ...
    <dialog ref="createModal" id="create_course_modal" class="modal">
      <div class="modal-box">
        ...
        <div class="form-control w-full mb-4">
          ...
          <input type="text" v-model="newCourse.title" placeholder="e.g. History 101" class="input input-bordered w-full" />
        </div>
        
        <div class="form-control w-full mb-4">
          <label class="label"><span class="label-text">Description</span></label>
          <textarea v-model="newCourse.description" class="textarea textarea-bordered h-24" placeholder="Course description..."></textarea>
        </div>
