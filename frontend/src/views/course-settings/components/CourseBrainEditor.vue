  ...
  <div v-else class="flex flex-col gap-6 animate-fade-in">
    ...
    <div v-if="isExternalAgent" class="animate-fade-in">
      <div class="alert alert-info mb-4">
        ...
        <span
          >This is an external agent. Configure the webhook endpoint and authentication below.</span
        >
      </div>
      <ExternalAgentForm
        ...
        <div class="card-body">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="form-control">
              ...
              <input
                type="number"
                v-model.number="config.context_window"
          ...
          <div v-else>
            <div class="border rounded-lg p-4 bg-base-50">
              ...
              <p class="text-xs text-gray-500 mb-3">
                ...
                <router-link to="/my-keys" class="text-primary hover:underline ml-1"
                  >Manage Keys</router-link
                >
              </p>
              ...
              <div v-else class="space-y-2 max-h-40 overflow-y-auto">
                <label
                  ...
                  :key="k.id"
                  class="flex items-center gap-3 p-2 hover:bg-white rounded cursor-pointer border border-transparent hover:border-gray-200 transition-colors"
                >
                  <input
                    type="checkbox"
                    :value="k.id"
