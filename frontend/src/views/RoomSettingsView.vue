  ...
  <div class="p-6 max-w-3xl mx-auto">
    ...
    <div class="card bg-base-100 shadow p-6 mb-6">
      ...
      <div class="form-control mb-6">
        <label class="label"
          ><span class="label-text font-bold text-lg">選擇 AI 介入模式</span></label
        >
        <div class="flex flex-col gap-3 mt-2">
          <label
            class="flex items-center gap-4 p-3 border rounded-lg cursor-pointer hover:bg-base-200 transition-colors"
            :class="{ 'border-primary bg-primary/5': aiMode === 'off' }"
          >
          ...
          <label
            class="flex items-center gap-4 p-3 border rounded-lg cursor-pointer hover:bg-base-200 transition-colors"
            :class="{ 'border-primary bg-primary/5': aiMode === 'teacher_only' }"
          >
          ...
          <label
            class="flex items-center gap-4 p-3 border rounded-lg cursor-pointer hover:bg-base-200 transition-colors"
            :class="{ 'border-primary bg-primary/5': aiMode === 'both' }"
          >
