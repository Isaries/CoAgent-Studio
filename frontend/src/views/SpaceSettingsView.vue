...
<template>
  <div class="h-full flex flex-col p-6 max-w-2xl mx-auto">
    <div class="flex justify-between items-center mb-6">
      ...
      <button class="btn btn-primary" @click="saveSpace" :disabled="isSaving || isLoading">
        ...
        <div class="form-control w-full">
          ...
          <div>
            ...
            <p class="text-xs text-base-content/50 mt-2">
              The preset determines the default configuration for your space. It cannot be changed
              after creation.
            </p>
          </div>
        </div>
    ...
    <div v-else class="alert alert-error">Space not found.</div>
  </div>
</template>
