...
<template>
  <div class="h-full flex flex-col bg-base-200 overflow-hidden">
    ...
    <div
      class="w-full bg-base-100 border-b border-base-300 px-6 py-3 flex justify-between items-center shadow-sm"
    >
    ...
    <div class="flex-1 p-6 overflow-y-auto">
      ...
      <div
        ...
        class="flex flex-col items-center justify-center p-12 opacity-50 h-full"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        ...
        class="flex flex-col items-center justify-center p-12 opacity-50 h-full bg-base-100 rounded-xl border border-dashed border-base-300"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <div class="card-body p-6">
            ...
            <div class="flex justify-between items-start mb-2">
              <h3
                class="font-bold text-lg leading-tight group-hover:text-primary transition-colors"
              >
                {{ agent.name }}
              </h3>
            ...
            <!-- Footer -->
            <div
              class="mt-4 pt-4 border-t border-base-200 flex items-center justify-between text-xs opacity-60"
            >
              ...
              <div
                class="flex items-center text-primary font-medium opacity-0 group-hover:opacity-100 transition-opacity"
              >
                Configure
                <svg
                  xmlns="http://www.w3.org/2000/svg"
